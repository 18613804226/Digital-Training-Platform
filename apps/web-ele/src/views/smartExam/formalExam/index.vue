...
<template>
  <div class="relative flex h-full flex-col p-4">
    ...
    <Page class="card-box flex-1 overflow-hidden rounded-lg" title="Exam - Answer Questions" :loading="loading">
      ...
      <template #default>
        ...
        <div class="space-y-4">
          ...
          <!-- 题目 -->
          <div v-for="(q, index) in questions" :key="index" class="mt-6 rounded border bg-white p-4 shadow-sm">

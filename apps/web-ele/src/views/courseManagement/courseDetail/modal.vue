...
async function initFormData() {
  ...
  // ✅ 深拷贝原始数据
  contentBlocks.value = structuredClone(blocks);
}
...
async function onConfirm() {
  formApi.setFieldValue('contentBlocks', structuredClone(contentBlocks.value));
  ...
  const payload = {
    ...
    content: structuredClone(contentBlocks.value), // ✅ 提交当前编辑状态
  };
